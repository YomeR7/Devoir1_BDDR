...
var tableObjectMongo = new Array;
var tableObjectSQL = [];
        ...
        for (let i = 1; i < 1601; i++) {
            request(url + i, function (error, response, body) {
                ...
                if (!error) {
                    ...
                    console.log(tableObjectMongo.push(JSONobject));
                    tableObjectSQL.push(objectSQL);
    
                   /* insert.insertSpellMongo(JSONobject,"DB","spells");
...
crawl().then(insert.insertSpellMongo(tableObjectMongo,"DB","spells"));
